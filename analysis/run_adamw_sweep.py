...
def _build_training_command(
    ...
    command = [
        ...
        "--config.experiment_kwargs.config.optimizer.name=adamw",
        f"--config.experiment_kwargs.config.optimizer.kwargs.weight_decay={weight_flag}",
        f"--config.experiment_kwargs.config.data.generator_config.n_common_classes={n_common}",
        f"--config.experiment_kwargs.config.data.generator_config.n_holdout_classes={n_holdout}",
        f"--config.experiment_kwargs.config.data.generator_config.n_rare_classes={rare_classes}",
